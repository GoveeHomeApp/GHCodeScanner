...
/// 扫码区域动画效果
public enum GHScanViewAnimationStyle {
...
/// 扫码区域4个角位置类型
public enum GHScanViewPhotoframeAngleStyle {
...
public struct GHScanViewStyle {
    ...
    /// 扫码区域的4个角类型
    public var photoframeAngleStyle = GHScanViewPhotoframeAngleStyle.Outer
    ...
    /// 扫码动画效果:线条或网格
    public var anmiationStyle = GHScanViewAnimationStyle.LineMove
