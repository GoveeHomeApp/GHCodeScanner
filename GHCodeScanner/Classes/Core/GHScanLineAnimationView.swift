//
//  GHScanLineAnimationView.swift
//  GHAuthManager
//
//  Created by songyang on 2023/10/20.
//  Copyright © 2023 Govee. All rights reserved.
//

import UIKit

class GHScanLineAnimation: UIImageView {
...
//        frame.origin.y -= hImg
    ...
    public static func instance() -> GHScanLineAnimation {
        return GHScanLineAnimation()
    }
